...
; CHECK: call void @llvm.memcpy.p4i8.p3i8.i64(i8 addrspace(4)* %dest, i8 addrspace(3)* %src.group.ptr, i64 %size, i32 4, i1 false), !alias.scope !3, !noalias !4, !tbaa_src !0, !tbaa_dest !0
...
<<<<<<< af689e8d8ffe7f892a9f75ce5367b9c41b154a94
...
>>>>>>> Split src/dest TBAA annotations for memcpy
  %cast.src = addrspacecast i8 addrspace(3)* %src.group.ptr to i8 addrspace(4)*
